                      ...
                      navigate(`/product/${bouquet.id}`, { 
                        state: { 
                          product: {
                            id: bouquet.id,
                            title: bouquet.name,
                            price: parseFloat(bouquet.price.replace('$', '')),
                  ...
                  >
                    ...
                    <div 
                      ...
                      style={{
                        ...
                        border: '1px solid rgba(199, 158, 72, 0.1)'
                      }}
                    >
                      {/* Image */}
                      <div 
                      ...
                      >
                        <motion.img
                          ...
                          className="transition-all duration-300 ease-out group-hover:scale-102 transform-gpu"
                        />
                        ...
                        {/* Luxury Price Tag */}
                        <motion.div 
                          className="absolute bottom-4 left-4 rounded-md bg-gradient-to-r from-amber-100 to-zinc-100 text-amber-800 px-3 py-1 font-luxury font-semibold text-sm border border-amber-200/60 shadow-sm inline-flex items-center gap-1" 
