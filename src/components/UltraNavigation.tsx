                  ...
                  >
                    <div className="flex flex-col h-full bg-background/98">
                      ...
                      <div className="flex items-center justify-between px-4 sm:px-6 py-4 border-b border-primary/10">
                        <span className="font-luxury text-lg font-bold text-foreground">Menu</span>
                        <Button
                          variant="ghost"
                          size="icon"
                          onClick={() => setIsMenuOpen(false)}
                          className="relative group hover:bg-primary/10 transition-all duration-300 rounded-full w-10 h-10"
                        >
                          <X className="w-6 h-6 text-foreground" />
                        </Button>
                      </div>

                      <div className="px-4 sm:px-6 py-6 sm:py-8 space-y-3 sm:space-y-4 overflow-y-auto flex-1">
                        {navigationItems.map((item, index) => {
                          const isActive = location.pathname === item.path;
                          return (
                            <motion.div
