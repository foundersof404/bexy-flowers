...
const LuxuryMenuIcon = ({ className, strokeWidth = "1" }: { className?: string; strokeWidth?: string | number }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
...
const LuxuryCloseIcon = ({ className, strokeWidth = "1" }: { className?: string; strokeWidth?: string | number }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="none"
    ...
    <>
      {!isCartOpen && (
        <>
                ...
                >
                  ...
                  >
                    ...
                    <div className="ml-1 sm:ml-1.5 block">
                      <h1
                        className="font-luxury text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl font-bold text-foreground whitespace-nowrap"
                      >
                        Bexy Flowers
                      </h1>
                    </div>
                  ...
                  {navigationItems.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        <Button
                          variant="ghost"
                          className={`relative group font-body font-medium px-3 xl:px-4 py-2 xl:py-3 transition-all duration-500 overflow-hidden ${isActive
                            ? 'text-foreground'
                ...
                <div className="flex items-center ml-auto gap-2">
                  ...
                  >
                    <Button
                      ...
                      className={`relative group hover:bg-primary/10 transition-all duration-500 overflow-hidden rounded-lg w-10 h-10 sm:w-12 sm:h-12 ${location.pathname === "/favorites" ? 'text-foreground' : 'text-foreground'
                        }`}
                    >
                      <motion.span
                ...
                >
                  ...
                  >
                    <Button
                      ...
                      size="icon"
                      onClick={() => handleNavigation("/favorites")}
                      className={`relative group hover:bg-primary/10 transition-all duration-300 overflow-hidden rounded-lg touch-target ${location.pathname === "/favorites" ? 'text-foreground' : 'text-foreground'
                        }`}
                      style={{
                        WebkitTapHighlightColor: 'transparent',
                        touchAction: 'manipulation',
          ...
          {/* Mobile Menu - 75% Height Slide Down */}
